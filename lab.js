...
//   console.log('One should wear a jacket and carry an umberella.')
// }else if (temperature >= 80 && rain === !true){
//   console.log('Wear a tank top!');
// }else if (temperature> 60-80 && rain === !true){
//   console.log('Wear a light jacket');
// }else if (temperature <= 60 && rain=== !true){
//   console.log('Bring a medium/heavy jacket.')
// }
...
// // //CODE HERE
//set up a for loop inside while set i in for loop to z
